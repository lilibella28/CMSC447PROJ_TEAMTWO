...
def _dispose_registries(registries: Set[_RegistryType], cascade: bool) -> None:
    ...
    for reg in registry._recurse_with_number_of_dependents(registries):
        if not cascade and reg._number_of_dependents.difference(orig):
            raise sa_exc.InvalidRequestError(
        ...
        reg._number_of_dependents.clear()
        for dep in reg._dependencies:
            dep._number_of_dependents.discard(reg)
